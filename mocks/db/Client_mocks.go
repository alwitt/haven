...
// UseDatabase provides a mock function for the type Client
func (_mock *Client) UseDatabase(ctx context.Context, coreLogic func(ctx context.Context, dbClient db.Database) error) error {
	ret := _mock.Called(ctx, coreLogic)

	if len(ret) == 0 {
		panic("no return value specified for UseDatabase")
	}
...
func (_e *Client_Expecter) UseDatabase(ctx interface{}, coreLogic interface{}) *Client_UseDatabase_Call {
	return &Client_UseDatabase_Call{Call: _e.mock.On("UseDatabase", ctx, coreLogic)}
}

func (_c *Client_UseDatabase_Call) Run(run func(ctx context.Context, coreLogic func(ctx context.Context, dbClient db.Database) error)) *Client_UseDatabase_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Client_UseDatabase_Call) Return(err error) *Client_UseDatabase_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Client_UseDatabase_Call) RunAndReturn(run func(ctx context.Context, coreLogic func(ctx context.Context, dbClient db.Database) error) error) *Client_UseDatabase_Call {
	_c.Call.Return(run)
	return _c
}
